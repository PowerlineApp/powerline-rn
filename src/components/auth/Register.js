  ...
  async requestLocation() {
    try {
      ...
      if (granted === PermissionsAndroid.RESULTS.GRANTED) {
        this.setState({
          country: this.state.country || DeviceInfo.getDeviceCountry()
        });
      } else {
      }
    } catch (err) {
      ...
      [
        {
          text: "Yes",
          onPress: () => {
            this.setState({ emailConfirmed: true, confirmingEmail: false });
          }
        },
        {
          text: "No",
          onPress: () => {
            this.setState({ email: "", confirmingEmail: false });
          }
        }
      ],
      { cancelable: false }
      ...
      <Container>
        <Content style={styles.container}>
          ...
          <Text style={styles.descriptionText}>
            This only requires 2 steps to get started!
          </Text>
          <View style={styles.formContainer}>
            ...
            <View style={styles.markContainer}>
              <View style={styles.markWrapper}>
                <View style={[styles.markItem, styles.markActiveItem]} />
          ...
          <ScrollView keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.formContainer}>
              <Text style={[styles.requireText, { textAlign: "left" }]}>
                <Text style={styles.starText}>*</Text>
                Powerline requires this information to link you to your
                communities and, if available, your specific elected leaders.
                This helps prove you are real and not a robot. We may also
                aggregate this information for anonymous reporting purposes.
              </Text>
              <GooglePlacesAutocomplete
                ...
                onPress={(data, details, any) => {
                  console.log(any);
                  this.onAutoComplete(data, details);
                }}
                query={{
                  key: googlePlacesKey,
                  language: "en",
                ...
                styles={{
                  ...
                  predefinedPlacesDescription:
                    styles.autoPredefinedPlacesDescription
                }}
              ...
              <Text style={[styles.requireText, { textAlign: "left" }]}>
                Your information is never shared with other users. Group leaders
                must receive your permission before they can access this
                information.
              </Text>
              <View style={styles.markContainer}>
                <View style={styles.markWrapper}>
        ...
        <View style={styles.formContainer}>
          <PhoneVerification
            ...
            onChangeCode={value => {
              this.setState(
                { code: value },
                value.length === 4 ? () => this.verifyCode() : () => {}
              );
            }}
