...
import TextExtraction from '../../../components/Feed/FeedDescription/TextExtraction';
...
class ParsedComment extends React.Component {
    ...
    handleUserPress = user => {
        try {
            const html = this.props.item.comment_body_html;
